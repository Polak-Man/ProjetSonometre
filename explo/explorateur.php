...
//Application Title
define('APP_TITLE', 'Explorateur de Fichiers');
...
$auth_users = array(
		'rootadmin' => '$2y$10$h/nZUtUf4hJP3.pBVW/ch.sa7wUBO2tIigqry9pY6mr4IoshI/hm6', //R00t@Admin!00
		'admin' => '$2y$10$IUXAvjh6zkq9oT.qiMPlmOwhhvYt5bl1T4sTNrC3UPENausCCLZKq', //!Admin01@
        'user' => '$2y$10$BHD/bq9Gi2YfmowPu./lNe.AbFYDjjHluzFh8b2nUkX9m6rsz0qgO' //password
...
$directories_users = array('user' => $_SERVER['DOCUMENT_ROOT']."/Sonometre/", 'admin' => $_SERVER['DOCUMENT_ROOT']."/Sonometre/");
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'txt,html';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'gif,jpeg,jpg,png,html';
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/prasathmani/tinyfilemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Aide') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/prasathmani/tinyfilemanager/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Reporter un problème') ?></a></li>
