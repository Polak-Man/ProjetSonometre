      ...
      // page GPIO 3     
          ...
          // GPIO 3  
            ...
            if (output3State=="on") {
              ...
              client.println("<p><a href=\"/3/on\"><button class=\"button button2\">ON</button></a></p>");
            } 
        ...
        // page accueil
            ...
            client.println(".titre { align-self: center; color: orange;}");
            client.println(".left_button { left: 5%; background-color: #195B6A; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".left_button2 {background-color: #77878A;}");
